...
gh pr create --base dfinity/repositories-open-to-contributions:master --head dfinity-sandox/repositories-open-to-contributions:master --draft --title "Integration Test 3" --body "generated by integration test from branch $GITHUB_HEAD_REF"

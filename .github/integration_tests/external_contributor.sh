...
gh pr create --repo dfinity/repositories-open-to-contributions --base $CURRENT_BRANCH --head dfinity-sandbox:integration-test-3 --draft --title "Integration Test 3" --body "generated by integration test from branch $GITHUB_HEAD_REF"

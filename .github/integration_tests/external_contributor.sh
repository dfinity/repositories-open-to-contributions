...
gh pr create --repo dfinity/repositories-open-to-contributions --base integration-test-3 --head integration-test-3 --draft --title "Integration Test 3" --body "generated by integration test from branch $GITHUB_HEAD_REF"
gh pr close integration-test-3

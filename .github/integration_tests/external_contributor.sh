...
gh pr create --base dfinity/repositories-open-to-contributions:$CURRENT_BRANCH --head dfinity-sandox/repositories-open-to-contributions:integration-test-$RUN_NUMBER --draft --title "Integration Test 3" --body "generated by integration test from branch $GITHUB_HEAD_REF"
